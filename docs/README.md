# Documentation For Axon Framework - Reactor Extension.

This folder contains the docs related to the Reactor Extension for Axon Framework. The docs in this folder are written as part of the [AxonIQ Library](https://library.axoniq.io), and are [written in Ascii and built with Antora.](https://library.axoniq.io/contribution_guide/overview/platform.html)

The following are the current documentation sources (folders):

- `extension-guide` : [The Reactor Extension Guide](https://library.axoniq.io/reactor-extension-reference/index.html)
