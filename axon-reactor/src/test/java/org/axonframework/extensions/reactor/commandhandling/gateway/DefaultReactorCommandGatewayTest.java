...
class DefaultReactorCommandGatewayTest {
    ...
    private void registerMessageMapping(ReactorCommandGateway gateway,
                                        Function<CommandMessage<?>, CommandMessage<?>> mapping) {
        gateway.registerDispatchInterceptor(mono -> mono.map(mapping));
    }

    private void registerResultMapping(ReactorCommandGateway gateway,
    ...
    private void registerMapping(ReactorCommandGateway gateway,
