...
/**
 * Contract which defines how to build a PreparedStatement for use on {@link JdbcEventStorageEngine#lastSequenceNumberFor(String)}
 *
 * @author Lucas Campos
 * @since 4.3
 */
...
public interface LastSequenceNumberForStatementBuilder {
     ...
     */
    Statement build(Connection connection, EventSchema schema, String aggregateIdentifier);
}
